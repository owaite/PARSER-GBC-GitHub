...
date_list <- c( 
  ...
  #               "2022_05_07",
  #               "2022_05_26",
  #                 "2022_06_07", ##### NEED TO ALIGN and export ORTHO for SiteB
  #                 "2022_06_22", 
  #                 "2022_07_05", 
  #                 "2022_07_21", 
  #                 "2022_07_28",#JAKE
  ...
  #                 "2023_05_23",
  #                 "2023_06_06",
                  "2023_06_22", #JAKE # need to copy from Jakes HD
                  "2023_08_18" #JAKE
)
...
# dir_crowns <- "K:\\Rainbow_A_Crowns\\Edited_as_of_2023_09_22_notDone\\Edited_CHM_.06_masked_RGB_H20T_thres45percent_2022_06_07_NAfilledminw3_medw3_gauss.sig.01w3_z75_crowns_2_AbsIncluded.shp"  

# Rainbow B crowns:
site = "Cw_PR_Rainbow_SiteB"
dir_crowns <- "K:\\Rainbow_B_Crowns\\Data\\Crowns\\Edited_Spencer\\CHM_.06_masked_RGB_H20T_thres45percent_2022_06_07_NAfilledminw3_medw3_gauss.sig.01w3_z75_crowns_2_EDITED.shp"
...
find_local_min <- function(values) {
  ...
  for (i in 2:length(values)) {
    ...
    if (values[i - 1] < 0 & values[i] >= 0 & i > 15) { #i>15 because local min will not be in first 15 and this stops an error occuring where a local min is found in teh first 15 values and the def_positive indexing doe snot work
      ...
      # neg_slope_startSection <- i - 15
      # neg_slope_endSection <- i - 10
      def_negative <- c(values[(i-15):(i-10)]) # vector of next 7 gradient values # 7 was used and found first min

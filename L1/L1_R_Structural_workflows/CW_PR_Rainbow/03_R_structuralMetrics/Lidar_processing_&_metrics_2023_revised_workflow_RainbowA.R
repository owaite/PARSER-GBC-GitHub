...
#change out all "A" and PlotA" with "B" and "PlotB" for rainbow plot B
...
# done: "2022_04_23"
date_list = c("2022_04_23","2022_11_28","2023_06_21","2023_12_17")

for (i in 1:length(date_list)){
  
  date = date_list[i]
  
  dir = paste0("A:\\WaiteOlivia_2\\Rainbow_L1\\",date,"\\PlotA")
...
date_list <- c("2022_11_20","2023_06_22")
...
las_files <- list.files(paste0("A:\\WaiteOlivia_2\\Rainbow_L1\\",date,"\\PlotA\\10_CROWNS_clean"), pattern = "\\.laz$", full.names = TRUE)
